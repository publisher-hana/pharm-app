        ...
        <LeftContent>
          ...
          <ListCol2>
            <li>
              ...
              <div className="title"><a href="#" css={ClampText.line1}>'길고양이 TNR, 마당개 중성화 문제 많다' 수의사회 보이콧 움직임</a></div>
            </li>
            <li>
               <span className="date">2022-01-26</span>
              <div className="title"><a href="#" css={ClampText.line1}>美 FDA가 ‘신속 심사’ 지정한 대웅제약 신약 후보물질은?</a></div>
            </li>
            <li>
               <span className="date">2022-01-26</span>
              <div className="title"><a href="#" css={ClampText.line1}>대웅펫-브이원바이오, ‘건강견 유래 유산균 영양제 개발 MOU’ 체결</a></div>
            </li>
            <li>
               <span className="date">2022-01-26</span>
              <div className="title"><a href="#" css={ClampText.line1}>마이클 켄트 UC DAVIS 교수는 방사선 치료를 주제로 작용 원리와 치료계획 수립, 예후를 함께 조명하다</a></div>
            </li>
            <li>
              <span className="date">2022-01-26</span>
              <div className="title"><a href="#" css={ClampText.line1}>'길고양이 TNR, 마당개 중성화 문제 많다' 수의사회 보이콧 움직임</a></div>
